  ...
  return [
    {
      ...
      collapsed: true,
      items: [
        { text: '029期--这个精彩的世界', link: '/posts/2025/029' },
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { text: '025期--AI时代更需要模板', link: '/posts/2024/025' },
  ...
  return [
    {
      ...
      collapsed: true,
      items: [
        { text: '029: This Wonderful World', link: '/en/posts/2025/029' },
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { text: '025: Templates Needed More in the AI Era', link: '/en/posts/2024/025' },
